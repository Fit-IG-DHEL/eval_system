...
if($action == 'delete_subject'){
	...
	$save = $crud->delete_subjectfromAS();
	if($save)
		echo $save;
}
...
if($action == 'delete_faculty'){
	...
	$save = $crud->delete_instructorlist();
	if($save)
		echo $save;
}
...
if($action == 'save_restriction2'){
	$save = $crud->save_restriction2();
	if($save)
		echo $save;
}
...
if($action == 'save_evaluation2'){
	$save = $crud->save_evaluation2();
	if($save)
		echo $save;
}
