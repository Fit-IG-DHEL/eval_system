...
<body class="hold-transition login-page bg-black"style="background-color:white;display:flex;
...
.container img[alt="logo2"] ,.container h4 {
  display: none;
}
.card{
  width: 100% !important;
...
<h4>Institute of Business Science and Medical Arts</h4>
  ...
  <img src="./ibsmafiles/logo2ibsma.jpg" alt="logo2" >
  ...
  <div class="card" >
    <div class="card-body login-card-body"style="padding:2em 4em;">
     ...
     /.col 
        ...
        <button type="submit" class="btn btn-primary btn-block"style="width:100%;background-color:green;border-color:green;">Log In</button>
