...
<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark "style="background-color:#026e02;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
    ...
    <?php endif; ?>
      <li id="fulss">
        <a class="nav-link text-white " id="t-eval-title" href="./" role="button"> <large><b id="t-eval-title"><?php echo $_SESSION['system']['name'] ?></b></large></a>
      </li>
    </ul>
