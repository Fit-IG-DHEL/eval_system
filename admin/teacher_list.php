	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_teacher"><i class="fa fa-plus"></i> Add New Teacher</a>
			</div>
		</div>
		<div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu">
		                      ...
		                      <a class="dropdown-item" href="./index.php?page=edit_teacher&id=<?php echo $row['id'] ?>">Edit</a>
		                      <div class="dropdown-divider"></div>
...
<script>
	...
	$('.view_faculty').click(function(){
		uni_modal("<i class='fa fa-id-card'></i>Teacher Details",
	...
	$('.delete_faculty').click(function(e){
		...
		if(wow === '0') {
			...
			_conf('Are you sure to delete this Teacher?','delete_faculty',[$(this).attr('data-id')])
		}
