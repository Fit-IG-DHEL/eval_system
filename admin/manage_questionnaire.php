		...
		<div class="col-md-8">
			<div class="card card-outline card-info">
				<div class="card-header">
					...
					<button class="btn btn-sm btn-flat btn-primary bg-gradient-primary mx-1" id="eval_restrict2" type="button" >irregular Evaluation Restriction</button>
						<button class="btn btn-sm btn-flat btn-primary bg-gradient-primary mx-1" id="eval_restrict" type="button">regular Evaluation Restriction</button>
					...
					<table class="table table-sm" >
						...
						<tbody class="tr-sortable">
							...
							<tr class="bg-white">
								...
								<td class="p-1" >
								<p style="width:100%;overflow-wrap:break-word;"><?php echo $row['question'] ?></p>
								...
								<!-- <td class="text-center" >
									<div class="icheck-success d-inline">
				                        <input disabled type="radio" name="qid[<?php //echo $row['id'] ?>][]" id="qradio<?php //echo $row['id'].'_'.$c ?>">
...
<script>
	...
	$('#eval_restrict').click(function(){
		uni_modal("Manage Evaluation Restrictions for Regular students","<?php echo $_SESSION['login_view_folder'] ?>manage_restriction.php?q=<?php echo $questions->num_rows ?>&id=<?php echo $id ?>","modal-xl")
	})
	$('#eval_restrict2').click(function(){
		uni_modal("Manage Evaluation Restrictions for Irregular students","<?php echo $_SESSION['login_view_folder'] ?>manage_restriction2.php?q=<?php echo $questions->num_rows ?>&id=<?php echo $id ?>","modal-xl")
	})
